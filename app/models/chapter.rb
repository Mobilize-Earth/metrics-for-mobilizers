class Chapter < ApplicationRecord
  ...
  validates :name, :total_mobilizers, :total_subscription_amount, :total_arrestable_pledges, presence: true
  validates :name, uniqueness: { case_sensitive: false }
  validates_length_of :name, maximum: 100
  validates :total_mobilizers, numericality: { only_integer: true, less_than_or_equal_to: 1_000_000_000 }
