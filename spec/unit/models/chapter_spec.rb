...
describe Chapter, type: :model do
  describe "when a new chapter is created" do
    ...
    it "should not save if active members is greater than 1,000,000,000" do
      ...
      chapter.valid?
      expect(chapter.errors[:active_members]).to include("must be less than or equal to 1000000000")
    end
    ...
    it "should not save if total subscription amount is greater than 1,000,000,000" do
      ...
      chapter.valid?
      expect(chapter.errors[:total_subscription_amount]).to include("must be less than or equal to 1000000000")
    end
    ...
    it "should not save if total chapter title is greater than 100 characters" do
      ...
      chapter.valid?
      expect(chapter.errors[:name]).to include("is too long (maximum is 100 characters)")
    end
  end
