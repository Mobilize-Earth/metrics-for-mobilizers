...
feature 'submitting arrestable action' do
    ...
    before(:each) do
        ...
        click_on 'National Arrestable Action'
    end
    ...
    scenario 'should save in database with right values' do
        ...
        expect(ArrestableAction.last.type_arrestable_action).to eq('National Arrestable Action')
    end
...
feature 'content' do
    ...
    scenario 'should have tabs' do
        expect(page).to have_content "Local Arrestable Action"
        expect(page).to have_content "Regional Arrestable Action"
        expect(page).to have_content "National Arrestable Action"
    end
end
